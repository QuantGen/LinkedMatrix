...
for (class in c("cmmMatrix", "rmmMatrix")) {
    ...
    for (nChunks in 1:2) {
        ...
        geno <- new(class, nrow = 3, ncol = 3, nChunks = nChunks)
        geno[] <- genotypes
        ...
        test_that("subsetting", {
            ...
            expect_true(all.equal(geno[, c(TRUE, FALSE, TRUE)], genotypes[, c(TRUE, FALSE, TRUE)]))
            expect_true(all.equal(geno[c(TRUE, FALSE, TRUE), c(TRUE, FALSE, TRUE)], genotypes[c(TRUE, FALSE, 
                TRUE), c(TRUE, FALSE, TRUE)]))
            expect_true(all.equal(geno[c(TRUE, FALSE, TRUE), , drop = FALSE], genotypes[c(TRUE, FALSE, TRUE), 
                , drop = FALSE]))
            expect_true(all.equal(geno[, c(TRUE, FALSE, TRUE), drop = FALSE], genotypes[, c(TRUE, FALSE, TRUE), 
                drop = FALSE]))
            expect_true(all.equal(geno[c(TRUE, FALSE, TRUE), c(TRUE, FALSE, TRUE), drop = FALSE], genotypes[c(TRUE, 
                FALSE, TRUE), c(TRUE, FALSE, TRUE), drop = FALSE]))
            ...
            expect_true(all.equal(geno[c("id_1", "id_2"), c("mrk_1", "mrk_2")], genotypes[c("id_1", "id_2"), 
                c("mrk_1", "mrk_2")]))
            expect_true(all.equal(geno[c("id_1", "id_2"), , drop = FALSE], genotypes[c("id_1", "id_2"), , drop = FALSE]))
            expect_true(all.equal(geno[, c("mrk_1", "mrk_2"), drop = FALSE], genotypes[, c("mrk_1", "mrk_2"), 
                drop = FALSE]))
            expect_true(all.equal(geno[c("id_1", "id_2"), c("mrk_1", "mrk_2"), drop = FALSE], genotypes[c("id_1", 
                "id_2"), c("mrk_1", "mrk_2"), drop = FALSE]))
            ...
            expect_true(all.equal(geno[c("id_2", "id_1"), c("mrk_2", "mrk_1")], genotypes[c("id_2", "id_1"), 
                c("mrk_2", "mrk_1")]))
            expect_true(all.equal(geno[c("id_2", "id_1"), , drop = FALSE], genotypes[c("id_2", "id_1"), , drop = FALSE]))
            expect_true(all.equal(geno[, c("mrk_2", "mrk_1"), drop = FALSE], genotypes[, c("mrk_2", "mrk_1"), 
                drop = FALSE]))
            expect_true(all.equal(geno[c("id_2", "id_1"), c("mrk_2", "mrk_1"), drop = FALSE], genotypes[c("id_2", 
                "id_1"), c("mrk_2", "mrk_1"), drop = FALSE]))
            ...
            expect_true(all.equal(geno[c("id_3", "id_1"), c("mrk_3", "mrk_1")], genotypes[c("id_3", "id_1"), 
                c("mrk_3", "mrk_1")]))
            expect_true(all.equal(geno[c("id_3", "id_1"), , drop = FALSE], genotypes[c("id_3", "id_1"), , drop = FALSE]))
            expect_true(all.equal(geno[, c("mrk_3", "mrk_1"), drop = FALSE], genotypes[, c("mrk_3", "mrk_1"), 
                drop = FALSE]))
            expect_true(all.equal(geno[c("id_3", "id_1"), c("mrk_3", "mrk_1"), drop = FALSE], genotypes[c("id_3", 
                "id_1"), c("mrk_3", "mrk_1"), drop = FALSE]))
